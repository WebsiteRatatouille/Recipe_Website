    ...
    const fetchRecipes = async (search = "", page = 1) => {
        ...
        try {
            ...
            const response = await axios.get(
                `${process.env.REACT_APP_API_URL}/api/recipes?keyword=${search}&page=${page}&limit=10`,
                {
                    headers: {
        ...
        <div className="my-recipes-container">
            ...
            <div className="recipes-content">
                <div className="recipes-actions">
                    ...
                    <button className="create-new-recipe-btn" onClick={handleCreateNewRecipe}>
                ...
                <div className="recipes-list">
                    ...
                    {/* Pagination */}
                    {!loading && !error && recipes && recipes.length > 0 && totalPages > 1 && (
