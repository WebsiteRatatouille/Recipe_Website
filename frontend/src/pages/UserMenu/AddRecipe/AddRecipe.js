    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (isEditing) {
                ...
                const token = localStorage.getItem("token");
                await axios.post(`${process.env.REACT_APP_API_URL}/api/recipes`, dataToSend, {
                    headers: {
                        Authorization: `Bearer ${token}`,
                    },
                });
                ...
                setNotification({
                    message: "Công thức mới đã được tạo thành công!",
                    type: "success",
                });
                window.scrollTo({ top: 0, behavior: "smooth" });
                setTimeout(() => {
        ...
        <div className="add-recipe-container">
            ...
            <div className="add-recipe-form">
                <div className="image-upload-section">
                    ...
                    <label htmlFor="imageFile" className="upload-box-main" ref={imageUploadRef}>
                        {uploading ? (
                            <p>Đang tải ảnh...</p>
                        ) : uploadError ? (
